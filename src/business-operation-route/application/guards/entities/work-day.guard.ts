...
export const isWorkDayEntity = (value: unknown): value is WorkDayEntity => {
  ...
  return (
    ...
    (value.final_petty_cash === null || value.final_petty_cash === undefined || typeof value.final_petty_cash === 'number') &&
    (value.id_payment_stub === null || value.id_payment_stub === undefined || typeof value.id_payment_stub === 'string')
  );
};
