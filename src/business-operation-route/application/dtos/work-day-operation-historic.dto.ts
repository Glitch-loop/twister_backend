...
export class WorkDayOperationHistoricDto {
	...
	@ApiPropertyOptional({ type: String, example: '4c89ea4d-e54a-4dcf-8426-330e584f2e5f' })
	public readonly id_client?: string;

	@ApiPropertyOptional({ type: String, example: 'a8d18c34-cf17-4d5f-a830-c6f26d6c976a' })
	public readonly id_route_transaction?: string;

	@ApiPropertyOptional({ type: String, example: '9aa5f773-f0cf-4d2f-a6d5-f11ff8e79fca' })
