...
export class RouteDayLocationDto {
  ...
  constructor(
    ...
    this.id_route_day = id_route_day; // This field might store the id of a route day or the id of a route day proposal. By convention, it was let as id_route_day.
