import type { InventoryOperationsDto } from '@/src/inventory/application/dtos/inventory-operations.dto';
...
export const isInventoryOperationsDto = (value: unknown): value is InventoryOperationsDto => {
  if (!isRecord(value)) {
    return false;
  }
