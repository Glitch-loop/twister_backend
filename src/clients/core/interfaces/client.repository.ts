...
export abstract class ClientRepository {
  ...
  abstract listClients(limit: number, lastCreatedAt?: Date, lastIdClient?: string, cellphone?: string, email?: string, legal_name?: string, name?: string): Promise<TaxClientInformationEntity[]>;
}
