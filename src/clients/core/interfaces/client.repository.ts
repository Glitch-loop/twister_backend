...
export abstract class ClientRepository {
  ...
  abstract listClients(limit: number, lastCreatedAt?: string, lastIdClient?: string, cellphone?: string, email?: string, legal_name?: string, name?: string): Promise<TaxClientInformationEntity[]>;
}
